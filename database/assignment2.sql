...
-- Modify the Tony Stark record to "Admin"
...
-- Use an inner join for fields from inventory and classification name for SPORTS
...
-- Update all records in inventory to add "/vehicles"
UPDATE public.inventory
